...
public class BeanToMap {
	private static Logger logger = LoggerFactory.getLogger(BeanToMap.class);
	...
	public BeanToMap(PropertyParser propertyParser) {
	 ...
	 * @param object
	 */
	public Map<String, String[]> getBeanPropertiesMap(Object object) {
		try {
	...
	public String[] getBeanPropertyValues(String rawProperty, Object object) {
		if (rawProperty == null) {
		...
		if (propertyParser.hasNestedProperty(property)) {
			...
			if (memberObject != null) {
				...
				return getBeanPropertyValues(nestedProperty, memberObject);
			}
		} else {
			try {
	...
	public Class getPropertyType(String rawProperty, Object object) {
		//separate the type and property names from the param: type.propertyName -> type, propertyName
		String type = propertyParser.getType(rawProperty);
		String property = propertyParser.getPropertyName(rawProperty);
	...
	public String getBeanPropertyValue(String rawProperty, Object object) {
		String[] propertyValues = getBeanPropertyValues(rawProperty, object);
