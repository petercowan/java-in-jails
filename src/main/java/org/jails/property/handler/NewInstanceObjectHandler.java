 ...
 */
public class NewInstanceObjectHandler extends AbstractNullObjectHandler {
	private static Logger logger = LoggerFactory.getLogger(NewInstanceObjectHandler.class);
